...
#[repr(C)]
pub struct GNetC {
  pub node: [APair; GNetC::G_NODE_LEN], // global node buffer
  pub vars: [APort; GNetC::G_VARS_LEN], // global vars buffer
  pub rbag: [APair; GNetC::G_RBAG_LEN], // global rbag buffer
...
impl GNetC {
  ...
  pub const TPC: usize = 1 << GNetC::TPC_L2;
  ...
  pub const G_RBAG_LEN: usize = GNetC::TPC * GNetC::RLEN;
