...
fn eval(main: &str, code: &str) -> (String, u64, u64) {
  ...
  let mut funs = dynfun::build_runtime_functions(&book);
        ...
        //body: df::DynTerm::Dup {
          ...
          //body: Box::new(df::DynTerm::Op2 {
            ...
            //val0: Box::new(df::DynTerm::Cal {
              //func: 0,
              //args: vec![Box::new(df::DynTerm::Var { bidx: 1 })]
            //}),
            //val1: Box::new(df::DynTerm::Cal {
              //func: 0,
              //args: vec![Box::new(df::DynTerm::Var { bidx: 2 })]
            //})
          //})
        //},
        //free: vec![(0, 1)]
  ...
  //let rewriter: rt::Rewriter = Box::new(move |mem, host, term| {
    ...
    //for dynrule in &dynfun.rules {
      ...
      //if matched {
        ...
        //for df::DynVar {param, field, erase} in &dynrule.vars {
          //match field {
